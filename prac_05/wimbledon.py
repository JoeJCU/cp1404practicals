    ...
    with open('wimbledon.csv', "r", encoding="utf-8-sig") as in_file:
        ...
        for read_row in read:  # iterating through each row in the data
            ...
            if countrys not in data_country_wins:
                data_country_wins.append(
                    countrys)  # adding the countrys into the list by checking if they aren't already in the list made

    return data_country_wins, data_champs_wins
